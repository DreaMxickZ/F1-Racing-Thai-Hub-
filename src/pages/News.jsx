...
import { Newspaper, Calendar, Clock, ChevronRight, TrendingUp } from 'lucide-react';
...
const SCOPED_CSS = `
  ...
  .f1-news-page .np-card:nth-child(1){animation-delay:0.05s}.f1-news-page .np-card:nth-child(2){animation-delay:0.10s}.f1-news-page .np-card:nth-child(3){animation-delay:0.15s}.f1-news-page .np-card:nth-child(4){animation-delay:0.20s}.f1-news-page .np-card:nth-child(5){animation-delay:0.25s}.f1-news-page .np-card:nth-child(6){animation-delay:0.30s}.f1-news-page .np-card:nth-child(7){animation-delay:0.35s}.f1-news-page .np-card:nth-child(8){animation-delay:0.40s}.f1-news-page .np-card:nth-child(9){animation-delay:0.45s}.f1-news-page .np-card:nth-child(10){animation-delay:0.50s}
        ...
        <div className="np-inner">
          ...
          {news.length > 0 ? (
            <>
              {/* Featured */}
              {featured && (
                <Link to={`/news/${featured.id}`} className="np-featured">
              ...
              {rest.length > 0 && (
                <div className="np-divider">
                  ...
                  <span className="np-divider-txt">ข่าวทั้งหมด</span>
                  <div className="np-divider-line" />
                </div>
              )}
